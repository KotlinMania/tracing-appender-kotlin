...
This file is the quick-reference operating contract for tracing-appender-kotlin. The longer
...
tracing-appender-kotlin is a Kotlin Multiplatform port of the upstream Rust crate or module
[`tracing-appender`](https://crates.io/crates/tracing-appender). Upstream Rust is the behavioral oracle while the
