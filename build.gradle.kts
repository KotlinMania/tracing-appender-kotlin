...
kotlin {
    ...
    val xcf = XCFramework("TracingAppender")

    macosArm64 {
        binaries.framework { baseName = "TracingAppender"; xcf.add(this) }
    }
    iosArm64 {
        binaries.framework { baseName = "TracingAppender"; xcf.add(this) }
    }
    ...
    swiftExport {
        moduleName = "TracingAppender"
        flattenPackage = "io.github.kotlinmania.tracingappender"
    }

    android {
        namespace = "io.github.kotlinmania.tracingappender"
        compileSdk = 34
        minSdk = 24
...
mavenPublishing {
    ...
    coordinates(group.toString(), "tracing-appender-kotlin", version.toString())
    ...
    pom {
        ...
        scm {
            url.set("https://github.com/KotlinMania/tracing-appender-kotlin")
            connection.set("scm:git:git://github.com/KotlinMania/tracing-appender-kotlin.git")
            developerConnection.set("scm:git:ssh://github.com/KotlinMania/tracing-appender-kotlin.git")
        }
    }
}
...
val fullTargetBuildTasks = listOf(
    ...
    "assembleTracingAppenderXCFramework",
    "assembleTracingAppenderDebugXCFramework",
    "assembleTracingAppenderReleaseXCFramework",
    "assembleDebugIosFatFrameworkForTracingAppenderXCFramework",
    "assembleReleaseIosFatFrameworkForTracingAppenderXCFramework",
    "assembleDebugIosSimulatorFatFrameworkForTracingAppenderXCFramework",
    "assembleReleaseIosSimulatorFatFrameworkForTracingAppenderXCFramework",
    "assembleDebugMacosFatFrameworkForTracingAppenderXCFramework",
    "assembleReleaseMacosFatFrameworkForTracingAppenderXCFramework",
    "assembleDebugTvosFatFrameworkForTracingAppenderXCFramework",
    "assembleReleaseTvosFatFrameworkForTracingAppenderXCFramework",
    "assembleDebugTvosSimulatorFatFrameworkForTracingAppenderXCFramework",
    "assembleReleaseTvosSimulatorFatFrameworkForTracingAppenderXCFramework",
    "assembleDebugWatchosFatFrameworkForTracingAppenderXCFramework",
    "assembleReleaseWatchosFatFrameworkForTracingAppenderXCFramework",
    "assembleDebugWatchosSimulatorFatFrameworkForTracingAppenderXCFramework",
    "assembleReleaseWatchosSimulatorFatFrameworkForTracingAppenderXCFramework",
